...
<?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <article style="width:100%">
        ...
        <div class="span8">
            ...
            <?php ($content = ""); ?>
            <?php for($i =0; $i<strlen($post->content); $i++): ?>
            ...
            <?php if(@$admin): ?>
                <a href="<?php echo e(route('admin.showPost', ['id'=> $post->id])); ?>" class="readmore">
                    Read more <i class="icon-angle-right"></i>
                </a>
            <?php else: ?>
            <a href="<?php echo e(route('showPost', ['id'=> $post->id])); ?>" class="readmore">
                Read more <i class="icon-angle-right"></i>
            </a>
            <?php endif; ?>
            </div>
...
<?php /**PATH C:\xampp3\htdocs\tech blog\resources\views/showPosts.blade.php ENDPATH**/ ?>
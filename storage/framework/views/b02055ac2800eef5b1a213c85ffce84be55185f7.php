    ...
    <header>
      ...
      <div class="container">
        ...
        <div class="row nomargin">
          <div class="span4">
            <div class="logo">
                <a href="<?php echo e(route('admin.adminPosts')); ?>" style="font-size:20px; text-transform:capitalize">
                    <img src="<?php echo e(asset('ico/favicon.png')); ?>" alt="" /> <?php echo e(auth()->guard('admin')->user()->name); ?>
                ...
                <nav>
                  <ul class="nav topnav">
                    <li class="dropdown active">
                      <a href="<?php echo e(route('admin.index')); ?>"><i class="icon-home"></i> Home <i class="icon-angle-down"></i></a>
                    </li>

                    <li class="dropdown">
                      <a href="#">Posts<i class="icon-angle-down"></i></a>
                      <ul class="dropdown-menu">
                        <li><a href="<?php echo e(route('admin.createPost')); ?>">Add</a></li>
                        <li><a href="<?php echo e(route('admin.posts')); ?>">show</a></li>
                      </ul>
                    </li>
                    <li class="dropdown">
...
<?php /**PATH C:\xampp3\htdocs\tech blog\resources\views/admin/navbar.blade.php ENDPATH**/ ?>
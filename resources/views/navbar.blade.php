      ...
      <div class="container">
        ...
        <div class="row nomargin">
          <div class="span4">
            <div class="logo">
               @if(auth()->check())
                <a href="{{route('index')}}" style="font-size:20px; text-transform:capitalize"><img src="{{asset('ico/favicon.png')}}" alt="" /> {{auth()->user()->name}}</a>
               @else
                <a href="{{route('auth')}}"style="font-size:25px; text-transform:capitalize; text-decoration:underline"><img src="{{asset('ico/favicon.png')}}" alt="" /> login</a>
               @endif
            </div>
          </div>
          <div class="span8">
              ...
              <div class="navigation">
                <nav>
                  <ul class="nav topnav">
                    ...
                    <li class="dropdown">
                      <a href="{{route('viewFav')}}">Favorite</a>
                    </li>
                    <li class="dropdown">
